  ...
  return (
    <Link href={`/blogs/${params.tag.id}/${params.post.id}`}>
      <motion.div
        ...
        className="group mb-[min(2vh,2vw)] grid grid-cols-12 items-center gap-0 rounded px-[2vh] py-[1vh] nm-flat-light-base hover:text-light-mauve dark:nm-flat-dark-base dark:hover:text-dark-mauve"
      >
        <h3 className="col-span-3 text-left font-bold">{params.post.title}</h3>
        <h3 className="col-span-7 px-[1vw] text-center">
