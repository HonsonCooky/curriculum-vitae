  ...
  return (
    <Link href={params.page.href}>
      <motion.li
        ...
        className="flex p-[2vw] text-[max(3vh,3vw)] leading-[max(3vh,3vw)] text-light-text aria-selected:text-light-mauve dark:text-dark-text aria-selected:dark:text-dark-mauve"
      >
        {params.page.title}
      </motion.li>
    </Link>
